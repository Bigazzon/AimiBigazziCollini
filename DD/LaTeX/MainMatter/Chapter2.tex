...
\captionof{figure}{Trip customization runtime view (I assume that the trip is already saved on the device, because otherwise it will have to be synced from the database)}
\end{center}
\end{landscape}
%
% ------------------------------------------------------------------------ %
